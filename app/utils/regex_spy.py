...
class RegexSpy:
    ...
    # Suspicious Keywords (for scoring/flagging) - Kept from original as it wasn't explicitly asked to be removed, 
    # but not part of the core extraction replacement. I will keep it for backward compatibility if used elsewhere.
    SUSPICIOUS_KEYWORDS = [
